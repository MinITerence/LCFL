...
def get_parser():
    ...
    parser.add_argument(
        "--root", metavar="DIR",
        default= '/data/mcc_fj/Match/physionet.org/files/challenge-2021/1.0.3/training/WFDB_ptb-xl',
        help="root directory containing dat files to pre-process"
    )
    parser.add_argument(
        "--dest", type=str, metavar="DIR",
        default= '/data/mcc_fj/Match/physionet.org/files/challenge-2021/1.0.3/training/ptb-xl',
