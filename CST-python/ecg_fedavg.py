...
def federated_main(args, wandb_run=None) :
    ...
    classes, score_weights = ( ecg_utils.get_physionet_weights("./ecg_federated/weights.csv") )
    ...
    for comms in range(args.communications):
        ...
        for c in range(len(args.data_list)) :
            ...
            valid_loss, valid_cinc = naive_test(args, model, valid_loader, score_weights, sinus_rhythm_index, criterion, c, device=device)
